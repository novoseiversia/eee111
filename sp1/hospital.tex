		...
		\subsection{Parser logic}
			...
			\subsubsection{Application of input rules}
				...
				\begin{itemize}
					...
					are invalid, since \verb|"Hello"| is not an integer, thus invalidating the entire
					list. However, \verb|["500", "World"]| is valid, since each argument follows its
					corresponding input rule.
